...
const button = cva(
  'flex items-center justify-center border font-medium focus:outline-none disabled:cursor-not-allowed disabled:opacity-70 group transition-colors rounded-br-xl',
  {
